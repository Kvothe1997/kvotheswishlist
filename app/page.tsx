    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col justify-center items-center gap-6 text-center sm:items-start sm:text-center">
          ...
          />
          <Card
            shopLink={"https://diadejuegos.pe/euro-games/3605-catan-duelo.html"}
            imageLink={"https://diadejuegos.pe/3368-large_default/catan-duelo.jpg"}
            title={"CATAN DUELO"}
            price={"S/. 90 soles"}
          />
          <Card
          ...
          />
          <Card
            shopLink={"https://www.falabella.com.pe/falabella-pe/product/153390812/consola-playstation-5-slim-digital-sony/153390813?kid=shopp44fc&gclsrc=aw.ds&gad_source=1&gad_campaignid=20114538213&gbraid=0AAAAADs9MO2aooNxTq_tGr64QgGunHWpL&gclid=CjwKCAjwl97RBhBWEiwAa9rbXeKv8YDbI2HaCAAEI1GxYnSNMxtVQjJo8eb2RPy4h4d7colXoK__phoCfuwQAvD_BwE"}
            imageLink={"https://media.falabella.com/falabellaPE/153390813_01/w=1200,h=1200,fit=pad"}
